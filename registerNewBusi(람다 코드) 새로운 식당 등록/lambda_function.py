...
def lambda_handler(event, context):
    ...
    bid = filterData(form_data["bid"])
    logBusId = filterData(form_data["logBusId"])
    ...
    try:
        ...
        insertNewBusiness(cursor ,busiName, phoneNumb,  country, city, streetAddr, emailAddr, bid , logBusId, psw, detailAddr)
        resPondMsg = "Success!"
